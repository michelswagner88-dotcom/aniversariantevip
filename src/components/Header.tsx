      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-20 border-b border-border/50">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <CakeIcon className="h-10 w-10 text-primary transition-transform group-hover:scale-110" />
        ...
        <nav className="hidden lg:flex items-center justify-center gap-8 h-14">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              to={link.href}
