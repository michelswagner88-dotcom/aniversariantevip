    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-xl border-b border-white/[0.08]" style={{ top: isBirthday && userName ? '48px' : '0' }}>
        ...
        <Link to="/" className="flex-shrink-0 group flex flex-col gap-0.5">
          ...
          <span className="hidden lg:block text-[9px] font-medium tracking-[0.05em] uppercase text-transparent bg-clip-text bg-gradient-to-r from-slate-300 via-violet-300 to-slate-300 opacity-0 animate-[fadeInSlide_0.8s_ease-out_0.3s_forwards]">
