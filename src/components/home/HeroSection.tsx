...
const HeroSection = memo(function HeroSection({
  ...
  const handleEstabelecimentoClick = useCallback(
    (est: EstabelecimentoSugestao) => {
      haptic(HAPTIC_LIGHT);
      navigate(`/estabelecimento/${est.slug}`);
      setShowEstabelecimentoDropdown(false);
      setBusca("");
    },
    [navigate],
  ...
  const cidadeDisplay = useMemo(() => {
    return cidade && estado ? `${cidade}, ${estado}` : "Selecionar cidade";
  }, [cidade, estado]);
  ...
  return (
    ...
    >
      <div className="relative z-10 container mx-auto px-2 sm:px-4 text-center">
        ...
        >
          Descubra restaurantes, bares, lojas e muito mais oferecendo vantagens no seu dia especial
        </p>
              ...
              {showCidadeDropdown && editandoCidade && (
                ...
                >
                  {isLoadingCidades ? (
                    ...
                    <ul className="max-h-[200px] overflow-y-auto" role="listbox">
