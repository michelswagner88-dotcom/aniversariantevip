...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none text-gray-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-violet-100 focus:text-gray-900 hover:bg-gray-100 cursor-pointer",
      className,
    )}
    {...props}
  >
