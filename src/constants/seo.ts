export const SEO_CONTENT = {
  home: {
    ...
    description: 'O maior guia de benefícios para aniversariantes do Brasil. Encontre restaurantes, bares, academias e mais de 50 categorias com vantagens especiais no seu aniversário. Cadastre-se grátis!',
  },
  explorar: {
    title: 'Explorar Estabelecimentos',
    description: 'Encontre estabelecimentos parceiros com benefícios exclusivos para aniversariantes. Filtre por cidade, categoria e descubra ofertas especiais.',
  },
  comoFunciona: {
    title: 'Como Funciona',
    description: 'Descubra como aproveitar benefícios exclusivos no seu aniversário. Cadastre-se grátis, encontre estabelecimentos parceiros e resgate suas vantagens.',
  },
  sejaParceiro: {
    title: 'Seja Parceiro',
    description: 'Cadastre seu estabelecimento no Aniversariante VIP e atraia clientes no dia mais especial deles. Aumente suas vendas com marketing direcionado.',
  },
  faq: {
    title: 'Perguntas Frequentes',
    description: 'Tire suas dúvidas sobre o Aniversariante VIP. Como usar benefícios, cadastro de estabelecimentos, e tudo que você precisa saber.',
  },
  termosUso: {
    title: 'Termos de Uso',
  ...
  feed: {
    ...
    description: 'Acompanhe as últimas novidades, promoções e eventos dos estabelecimentos parceiros do Aniversariante VIP.',
  },
  flashDeals: {
  ...
  auth: {
    ...
    description: 'Acesse sua conta ou cadastre-se gratuitamente para aproveitar benefícios exclusivos no seu aniversário.',
  },
  dashboard: {
    title: 'Minha Área',
...
export const getCidadeSEO = (cidade: string, estado: string, totalEstabelecimentos?: number) => ({
...
export const getCategoriaSEO = (categoria: string, cidade?: string, estado?: string) => {
  const local = cidade ? ` em ${cidade}, ${estado}` : '';
  return {
...
export const getEstabelecimentoSEO = (estabelecimento: {
  ...
  return {
    ...
    description: estabelecimento.descricao_beneficio 
      ? `${nome} oferece: ${estabelecimento.descricao_beneficio}. Aproveite este benefício exclusivo para aniversariantes em ${cidade}, ${estado}!`
      : `Confira os benefícios exclusivos para aniversariantes no ${nome}, ${categoria} em ${cidade}, ${estado}.`,
