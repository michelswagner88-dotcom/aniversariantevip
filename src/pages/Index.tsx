                  ...
                  {group.estabelecimentos.map((estabelecimento, index) => (
                    ...
                    >
                      ...
                      <CardContent className="space-y-3 px-4 sm:px-6 pb-4 sm:pb-6">
                        ...
                        {(estabelecimento.whatsapp || estabelecimento.instagram || estabelecimento.site) && (
                            ...
                            <div className="flex gap-2">
                              {estabelecimento.whatsapp && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={() => trackEvent(estabelecimento.id, "clique_whatsapp_rapido")}
                                  className="p-3 rounded-full bg-green-500/10 hover:bg-green-500/20 text-green-600 dark:text-green-400 transition-all hover:scale-110"
                              ...
                              {estabelecimento.instagram && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={() => trackEvent(estabelecimento.id, "clique_instagram_rapido")}
                                  className="p-3 rounded-full bg-pink-500/10 hover:bg-pink-500/20 text-pink-600 dark:text-pink-400 transition-all hover:scale-110"
                              ...
                              {estabelecimento.site && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={() => trackEvent(estabelecimento.id, "clique_site_rapido")}
                                  className="p-3 rounded-full bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 dark:text-blue-400 transition-all hover:scale-110"
                                  aria-label="Visitar Site"
                                  title="Site"
                                >
