                      ...
                      <CardContent className="space-y-3 px-4 sm:px-6 pb-4 sm:pb-6">
                        ...
                        {estabelecimento.telefone && (
                          <div className="flex items-center gap-2">
                            <a 
                              ...
                              className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors min-h-[44px] py-2 flex-1"
                            ...
                            <a 
                              ...
                              className="p-2 rounded-full bg-green-500 hover:bg-green-600 text-white transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                              aria-label="WhatsApp"
                            >
                        ...
                        <div className="pt-3 mt-3 border-t border-border">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() => handleShare(estabelecimento, 'twitter')}
                              className="p-2 rounded-full bg-sky-500/10 hover:bg-sky-500/20 text-sky-600 dark:text-sky-400 transition-colors"
