...
const estabelecimentosFicticios = [
  ...
  },
  {
    ...
    logoUrl: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=200&h=200&fit=crop",
  ...
  },
  {
    ...
    periodoValidade: "dia",
    linkCardapioDigital: "",
    logoUrl: "https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?w=200&h=200&fit=crop",
  ...
  // São Paulo - São Paulo
  {
    ...
    logoUrl: "https://images.unsplash.com/photo-1559339352-11d035aa65de?w=200&h=200&fit=crop",
  ...
  },
  {
    ...
    periodoValidade: "mes",
    linkCardapioDigital: "",
    logoUrl: "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=200&h=200&fit=crop",
  ...
  },
  {
    ...
    periodoValidade: "dia",
    linkCardapioDigital: "",
    logoUrl: "https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=200&h=200&fit=crop",
  ...
  // Distrito Federal - Brasília
  {
    ...
    logoUrl: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=200&h=200&fit=crop",
  ...
  },
  {
    ...
    logoUrl: "https://images.unsplash.com/photo-1521305916504-4a1121188589?w=200&h=200&fit=crop",
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-gradient-to-b from-primary/10 to-background print:hidden">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 text-foreground leading-tight">
            O MAIOR SITE DE BENEFICIOS PARA ANIVERSÁRIANTES DO BRASIL
          </h2>
