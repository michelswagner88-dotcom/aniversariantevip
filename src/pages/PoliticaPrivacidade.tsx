          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 p-8 md:p-12 space-y-8 shadow-[0_0_50px_-12px_rgba(139,92,246,0.3)]">
            <section>
              ...
              <p className="text-slate-300 leading-relaxed mb-4">
                Em conformidade com a Lei Geral de Proteção de Dados (LGPD - Lei 13.709/2018), coletamos os seguintes
                dados pessoais:
              </p>
            ...
            <section>
              ...
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">Identificação:</strong> Criar e gerenciar sua conta na plataforma
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-violet-400 mt-1 font-bold">2.</span>
                  <span>
                    <strong className="text-white">Emissão de Cupons:</strong> Verificar elegibilidade e gerar cupons de
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">Comunicação:</strong> Enviar notificações sobre novos benefícios,
                    ofertas e atualizações da plataforma
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-violet-400 mt-1 font-bold">4.</span>
                  <span>
                    <strong className="text-white">Melhoria:</strong> Analisar uso da plataforma para aprimorar
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">Segurança:</strong> Prevenir fraudes, abuso e garantir a integridade
                    da plataforma
                  </span>
                </li>
              </ul>
            ...
            <section>
              ...
              <div className="bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 rounded-lg p-6 border border-violet-500/20">
                ...
                <ul className="mt-4 space-y-2 text-slate-300">
                  <li>
                    <strong className="text-white">• Consentimento (Art. 7º, I):</strong> Você consente expressamente ao
                    aceitar esta Política ao criar sua conta
                  </li>
                  <li>
                    <strong className="text-white">• Execução de Contrato (Art. 7º, V):</strong> Necessário para
                    fornecimento do serviço de intermediação de benefícios
                  </li>
                  <li>
                    <strong className="text-white">• Legítimo Interesse (Art. 7º, IX):</strong> Para melhoria da
            ...
            <section>
              ...
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">Estabelecimentos Parceiros:</strong> Quando você emite um cupom, o
                    estabelecimento recebe apenas seu <strong className="text-white">nome</strong> e{" "}
                    <strong className="text-white">código do cupom</strong> para validação. Não compartilhamos CPF,
                    telefone, endereço ou outros dados sensíveis.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-violet-400 mt-1">•</span>
                  <span>
                    <strong className="text-white">Prestadores de Serviços:</strong> Empresas que auxiliam na operação
                    da plataforma (hospedagem Supabase, infraestrutura de e-mail) sob rígidos acordos de
                    confidencialidade.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-violet-400 mt-1">•</span>
                  <span>
                    <strong className="text-white">Autoridades:</strong> Quando exigido por lei, ordem judicial ou
            ...
            <section>
              ...
              <ul className="space-y-2 text-slate-300">
                <li>
                  <strong className="text-white">• Cookies Essenciais:</strong> Necessários para funcionamento da
                  plataforma (sessão, autenticação)
                </li>
                <li>
                  <strong className="text-white">• Cookies de Preferências:</strong> Armazenam suas escolhas (tema,
                  idioma, configurações)
                </li>
                <li>
                  <strong className="text-white">• Cookies Analíticos:</strong> Nos ajudam a entender como você usa a
                  plataforma (anonimizados)
                </li>
              </ul>
              <p className="text-slate-300 leading-relaxed mt-4">
                Você pode gerenciar suas preferências de cookies através das configurações do seu navegador. Desabilitar
            ...
            <section>
              ...
              <p className="text-slate-300 leading-relaxed">
                Mantemos seus dados pessoais enquanto sua conta estiver ativa ou conforme necessário para cumprir as
                finalidades descritas nesta política. Após solicitação de exclusão de conta, seus dados serão
                permanentemente excluídos em até <strong className="text-white">30 dias</strong>, exceto quando a
                retenção for necessária para cumprimento de obrigações legais ou regulatórias.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300 leading-relaxed">
                ...
                práticas ou na legislação. Notificaremos sobre alterações significativas por e-mail ou através de aviso
                destacado na plataforma. Recomendamos revisar esta página regularmente.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 rounded-lg p-6 border border-violet-500/20">
              ...
              <p className="text-slate-300 mb-6">
                Para exercer seus direitos, esclarecer dúvidas ou enviar solicitações relacionadas ao tratamento de
                dados pessoais, entre em contato com nosso{" "}
              ...
              <div className="mt-6 pt-6 border-t border-white/10">
                <p className="text-slate-400 text-sm">
                  <strong className="text-white">Aniversariante VIP</strong> • CNPJ: 00.000.000/0001-00
                  <br />
